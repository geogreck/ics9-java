...
List<T> – последовательность значений типа T, реализованная через двунаправленный список с операциями
поиска значения, вставки значения в указанное место, удаления значения. В List<int> дополнительно
должна присутствовать операция вычисления суммы значений. 
