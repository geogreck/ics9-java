...
Знакомство c библиотекой [PointNet](https://github.com/charlesq34/pointnet)
...
![Процесс обучения](pics/rk2_ex1_process.png)

Вывод нейросети после 20 итераций:

![Вывод натренированной нейросети](pics/rk2_ex1_out.png)
...
mesh = trimesh.load(os.path.join(DATA_DIR, "toilet/train/toilet_0001.off"))
mesh.show()
